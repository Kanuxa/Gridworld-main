...
Paired seeds: 2. Mean coverage delta: **0.000**; mean seen delta: **0.000**.
Coverage improved on 0 paired seeds and regressed on 0.

### Largest coverage regressions

| Seed | Current | Baseline | Delta |
| --- | --- | --- | --- |
| 16000 | 0.076 | 0.076 | 0.000 |
| 16001 | 0.076 | 0.076 | 0.000 |
...
| --- | --- | --- | --- | --- | --- |
| 16000 | 0.076 | 0.373 | truncated | 0.000 | truncated, fatigue_health_loss, phase2_not_reached |
| 16001 | 0.076 | 0.409 | truncated | 0.000 | truncated, fatigue_health_loss, phase2_not_reached |
